        ...
        >
          ...
          >
            ...
            <div className="px-8 pb-8 -mt-6 relative">
              <p className="text-[11px] font-bold tracking-widest uppercase mb-1.5 text-[#1a1715]/60 dark:text-white/60">
                {selectedBook.author}
              </p>
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 xl:grid-cols-8 gap-x-4 md:gap-x-6 gap-y-10 md:gap-y-12">
        {items.map((item) => (
          <div key={item.id} className="flex flex-col group">
            ...
            <p className="text-[10px] font-bold tracking-widest uppercase text-text-muted mb-5 line-clamp-1">
              {item.author}
            </p>
